...
The choice of architecture depends on factors like scalability requirements, team structure, and system complexity.`;
  ...
  return <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card className="shadow-elegant">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <Textarea placeholder="Enter your question about software architecture, computer architecture, or any technical topic..." value={question} onChange={e => setQuestion(e.target.value)} className="min-h-[120px] resize-none" />
            
            <Button type="submit" className="w-full bg-gradient-primary hover:shadow-glow transition-all duration-300" disabled={isLoading || isIngesting}>
              {isLoading ? <>
            ...
            <Tabs defaultValue="pdf" className="w-full">
              ...
              <TabsContent value="pdf" className="space-y-4">
                <div className="border-2 border-dashed border-border rounded-lg p-6 text-center hover:border-primary/50 transition-colors">
                  ...
                  {pdfFile && <p className="text-sm text-primary mt-2">
              ...
              <TabsContent value="github" className="space-y-4">
                <Input placeholder="https://github.com/username/repository" value={githubRepo} onChange={e => setGithubRepo(e.target.value)} className="w-full" />
              </TabsContent>
            </Tabs>
            
            <Button type="button" variant="outline" onClick={handleIngestData} className="w-full" disabled={isIngesting || isLoading}>
              {isIngesting ? <>
                  <Loader2 className="h-4 w-4 mr-2 animate-spin" />
                  Ingesting Data...
                </> : <>
      ...
      {/* Results */}
      {(answer || isLoading) && <Card className="shadow-elegant">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-primary">
          ...
          <CardContent>
            {isLoading ? <div className="flex items-center justify-center py-12">
                <div className="text-center space-y-4 mx-0 py-[20px]">
                ...
                <div>
                  ...
                  <div className="grid gap-4">
                    {sources.map((source, index) => <Card key={index} className="border-l-4 border-l-accent">
                        <CardContent className="pt-4">
                          <div className="flex items-start justify-between mb-2">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {source.score && <Badge variant="outline" className="text-xs">
